...
impl Str {
        ...
        S: AsRef<str>,
    {
        needles
            .into_iter()
            .all(|needle| value.contains(needle.as_ref()))
    }
...
mod tests {
    ...
    fn slices_strings() {
        ...
        assert_eq!(
            Str::after_last("App\\Http\\Controllers", "\\"),
            "Controllers"
        );
    ...
    fn formats_strings() {
        ...
        assert_eq!(
            Str::words("Berserk is a Rust framework", 3),
            "Berserk is a..."
        );
