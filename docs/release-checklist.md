...
- [ ] Confirm all publishable crates use the intended coordinated release version and that examples/benchmarks remain non-publishable where required.
...
- [ ] Review changelog, upgrade notes, known limitations, MSRV, support policy, public API, and examples for the exact release candidate.
